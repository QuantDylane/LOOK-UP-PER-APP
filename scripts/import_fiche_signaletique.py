"""
Importer les métadonnées FCP depuis 'data/Fiche signalétique des FCP.xlsx'
...
Utilisation :
    ...
    python scripts/import_fiche_signaletique.py --fichier "data/Fiche signalétique des FCP.xlsx"
"""
...
def main():
    ...
    parser.add_argument(
        "--fichier",
        default="data/Fiche signalétique des FCP.xlsx",
